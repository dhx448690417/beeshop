...
public class VerifyUtil {
    ...
    public static boolean checkCellPhone(String cellPhoneNr) {
        String reg = "^0{0,1}(13[0-9]|15[0-9]|173|176|177|178|147|145|170|18[0-9])[0-9]{8}$";
     ...
     * http://163.com
     */
    public static boolean checkChineseName(String url) {
        //http://www.163.com
        String reg = "(^[\\u4e00-\\u9fa5][\\u4e00-\\u9fa5 ·]*[\\u4e00-\\u9fa5]$)|^[\\u4e00-\\u9fa5]$";
    ...
    public static boolean checkPassword(String password) {
        ...
        //http://www.163.com
        String reg = "^([a-zA-Z]*?)((?:[0-9]+(?:[0-9]|[a-zA-Z])*)*)$";
